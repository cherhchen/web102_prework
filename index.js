...
let displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalNumGames} games. Currently, ${numUnfundedGames} ${numUnfundedGames > 1 ? "remain" : "remains"}. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
let newDisplayStr = document.createElement("div");
newDisplayStr.innerHTML = `<p>${displayStr}</p>`
descriptionContainer.append(newDisplayStr);
